...
- **Seiso** -  Remove unwanted items and arrange the necessary items in a orderly way
- **Seiketsu** - Consistently apply the cleanling practice
- **Shitsuke** - Train so that the system is maintained without explicit instructions
